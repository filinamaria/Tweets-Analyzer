                ...
                <div class="slide active" data-anchor="main">
                    <div id="query">
                        <form action="#main/result" method="post">
                            <input type="text" id="tweetkeyword" name="tweetkeyword" placeholder="Twitter Hashtag" />
                            ...
                            <%
                                ...
                                if(keyword3 != null){
                                    ...
                                    try{
                                        ...
                                        out.println("Traffic Category");
                                        out.println("<BR>");
                                        out.println("Number of Tweets: " + Macet.tweets.size());
                                        out.println("<BR>");
                                        ...
                                        out.println("Traffic Accident Category");
                                        out.println("<BR>");
                                        out.println("Number of Tweets: " + Kecelakaan.tweets.size());
                                        out.println("<BR>");
                                        out.println("Location: "); 
                                        out.println("<BR>");
                                        ...
                                        out.println("Closed Road Category");
                                        out.println("<BR>");
                                        out.println("Number of Tweets: " + Tutup.tweets.size());
                                        out.println("<BR>");
                                        out.println("Location: "); 
                                        out.println("<BR>");
                                        ...
                                        out.println("<BR>");
                                        out.println("Number of Tweets: " + Unknown.tweets.size());
                                        out.println("<BR>");
                                        out.println("Location: "); 
                                        out.println("<BR>");
